      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {/* Price Range */}
            <div className="mt-6">
              <h3 className="font-medium text-gray-700 mb-3">Price Range (Rs.)</h3>
        ...
        <p className="text-gray-600 mb-6">
          Showing <span className="font-semibold text-teal-600">{filteredProperties.length}</span> properties
