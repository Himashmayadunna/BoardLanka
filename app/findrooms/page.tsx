          ...
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            {selectedBedrooms > 0 && (
              <span className="bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-sm flex items-center gap-1">
                🛏️ {selectedBedrooms === 3 ? "3+ Bedrooms" : `${selectedBedrooms} Bedroom${selectedBedrooms > 1 ? 's' : ''}`}
                <button
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-gray-900 border border-gray-700/50 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="relative h-64 md:h-96">
              <Image
                src={selectedProperty.images?.[currentImageIndex] || "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800"}
