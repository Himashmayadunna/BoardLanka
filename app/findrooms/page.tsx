    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-600 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
            ...
            {selectedLocation && (
              <span className="block text-yellow-300 text-2xl mt-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-gray-600 mb-6">
          Showing <span className="font-semibold text-emerald-600">{filteredRooms.length}</span> rooms
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div className="bg-emerald-50 rounded-xl p-4">
                  <p className="text-sm text-emerald-600 font-medium mb-1">Monthly Rent</p>
                  ...
                  <div className="bg-gray-50 rounded-xl p-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <a
                        ...
                        className="flex items-center gap-3 bg-white p-3 rounded-lg hover:bg-emerald-50 transition-colors"
                      >
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-800">{selectedRoom.seller.phone}</p>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-800">{selectedRoom.seller.email}</p>
                        </div>
                      </a>
                    </div>
