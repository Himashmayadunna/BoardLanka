          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center">
                <span className="font-bold text-xl">BL</span>
              </div>
              <span className="font-bold text-2xl">BoardLanka</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-sm">
              Sri Lanka&apos;s most trusted platform for finding and listing rental
              properties. Connect with verified owners and find your perfect
              boarding place.
            </p>
            {/* Social Media Links */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start space-x-3">
              ...
              <div>
                ...
                <p className="text-white font-medium">info@boardlanka.lk</p>
              </div>
            </div>
            <div className="flex items-center justify-center md:justify-start space-x-3">
              <div className="w-10 h-10 bg-emerald-600/20 rounded-full flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm text-center md:text-left">
              © 2026 BoardLanka. All rights reserved. Made with ❤️ in Sri Lanka
            </p>
