      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-lg font-bold text-gray-900">BoardLanka</span>
          </div>
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-900 hover:bg-blue-800 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200"
            >
